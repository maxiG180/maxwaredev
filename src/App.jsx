  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#cbd5e1] font-sans antialiased selection:bg-white selection:text-black">
      ...
      <nav className="fixed top-0 left-0 w-full z-50 h-20 flex items-center border-b border-white/[0.03] bg-[#050505]/95 backdrop-blur-xl px-8 md:px-16">
        <div className="container mx-auto flex justify-between items-center text-white text-left">
      ...
      <main className="container mx-auto px-8 md:px-16 text-left">
        ...
        <section className="min-h-screen flex flex-col justify-center pt-32 pb-20 text-left">
          <div className="grid lg:grid-cols-[1fr_auto] gap-24 items-center w-full reveal text-left">
            ...
            <div className="max-w-2xl py-10 text-left">
              ...
              <div className="flex items-center gap-10 text-left">
                ...
                <div className="flex gap-6 text-left">
                  ...
                  <a href="https://github.com/maxiG180" target="_blank" className="text-gray-600 hover:text-white transition-colors text-left"><i className="fab fa-github text-lg text-left"></i></a>
            ...
            <div className="hidden lg:flex flex-col gap-10 text-left">
              {/* Profile */}
              <div className="w-[350px] h-[350px] rounded-[3rem] overflow-hidden border border-white/[0.05] shadow-2xl text-left">
                <img 
              ...
              >
                ...
                <div className="flex items-center gap-6 text-left">
                  ...
                  <div className="w-14 h-16 bg-[#111] rounded-lg flex flex-col gap-1.5 p-3 border border-white/10 shadow-xl shrink-0 group-hover:border-white/30 transition-colors text-left">
                    <div className="w-full h-[1px] bg-gray-700"></div>
                    <div className="w-4/5 h-[1px] bg-gray-700"></div>
                    <div className="w-full h-[1px] bg-gray-700"></div>
                    <div className="w-3/5 h-[1px] bg-gray-700"></div>
                    <div className="mt-auto self-end">
                      <i className="far fa-file-pdf text-[10px] text-gray-500 group-hover:text-white transition-colors text-left"></i>
                    </div>
                  </div>
                  <div className="text-left">
                    <div className="text-sm font-light text-white uppercase tracking-[0.2em] leading-none mb-2 text-left">Technical CV</div>
                    <div className="text-[9px] text-gray-400 font-light uppercase tracking-widest italic text-left">Click to review full screen</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-3xl space-y-24 text-left">
              ...
              <div className="space-y-12 text-left">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-10 border-b border-white/[0.03] pb-12 text-white text-left">
                  <div className="flex items-center gap-10 text-left">
                    <div className="w-24 h-24 shrink-0 flex items-center justify-center transition-transform duration-500 hover:scale-110 text-left">
                      <img src="/resources/fontyslogo.png" alt="Fontys" className="max-w-full max-h-full object-contain text-left" />
                    </div>
                    <div className="text-left">
                ...
                <div className="space-y-6 text-left">
                  <div className="inline-block px-4 py-1.5 bg-white/5 border border-white/10 text-white text-[9px] font-light uppercase tracking-[0.4em] rounded-lg italic text-left">
                    Delta Excellence Programme
                  </div>
                  <p className="text-gray-400 font-extralight leading-relaxed max-w-2xl text-lg italic text-left">
              ...
              <div className="grid md:grid-cols-2 gap-16 pt-8 text-left">
                <div className="p-10 bg-white/[0.01] border border-white/[0.03] rounded-[2.5rem] hover:bg-white/[0.02] transition-all group text-left">
                  <div className="flex items-center gap-6 mb-8 text-left">
                    <img src="/resources/inetelogo.png" alt="INETE" className="h-14 object-contain transition-all shrink-0 text-left" />
                ...
                <div className="p-10 bg-white/[0.01] border border-white/[0.03] rounded-[2.5rem] hover:bg-white/[0.02] transition-all group text-left">
                  <div className="flex items-center gap-6 mb-8 text-left">
                    <img src="/resources/assembly.png" alt="Assembly" className="h-14 object-contain transition-all shrink-0 text-left" />
              ...
              {[
                ...
                <div key={i} className="reveal group text-left">
                  <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 border-b border-white/[0.03] pb-10 gap-8 text-left">
                    <div className="flex items-center gap-10 text-left">
                      <div className={`${exp.isLarge ? 'w-32 h-32' : 'w-24 h-24'} shrink-0 flex items-center justify-center transition-transform duration-500 hover:scale-110 text-left`}>
                        <img src={exp.logo} alt={exp.company} className="max-w-full max-h-full object-contain text-left" />
                      </div>
                      <div className="text-left">
                  ...
                  <div className="flex flex-wrap gap-x-10 gap-y-5 text-[9px] font-normal text-gray-600 uppercase tracking-[0.3em] text-left">
                    {exp.tech.map(s => (
        ...
        <section id="projects" className="py-40 border-t border-white/[0.03] text-left">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 reveal text-white text-left">
            ...
            <p className="text-gray-400 text-[9px] font-light uppercase tracking-[0.5em] mt-4 md:mt-0 italic text-left">Architecture • Operations</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-px bg-white/[0.03] border border-white/[0.03] reveal rounded-[3rem] overflow-hidden shadow-2xl text-left">
            {[
              ...
              <div key={i} className="bg-[#050505] p-16 md:p-24 hover:bg-[#080808] transition-all group relative overflow-hidden text-left">
                ...
                <div className="text-[9px] font-normal text-gray-400 uppercase tracking-[0.5em] mb-12 group-hover:text-white transition-colors italic text-left">{p.client}</div>
                <h4 className="text-4xl font-normal text-white mb-8 tracking-widest uppercase leading-tight text-left">{p.title}</h4>
                <p className="text-gray-500 text-lg mb-12 font-extralight leading-relaxed italic text-left">{p.desc}</p>
                <div className="flex gap-10 text-[9px] font-light text-gray-600 uppercase tracking-[0.3em] text-left">
        ...
        <footer className="py-32 border-t border-white/[0.03] flex flex-col md:flex-row justify-between items-center gap-12 text-white text-left">
          ...
          <div className="flex gap-12 md:gap-16 text-left">
            {['Email', 'LinkedIn', 'GitHub'].map(link => (
              <a key={link} href={link === 'Email' ? 'mailto:maksymgrebeniuk@gmail.com' : link === 'LinkedIn' ? 'https://linkedin.com/in/maksym-grebeniuk-7a8b63174' : 'https://github.com/maxiG180'} target="_blank" className="text-[9px] font-light uppercase tracking-[0.5em] hover:text-white transition-colors border-b border-white/10 pb-1 italic text-left">
                {link}
              </a>
            ))}
          </div>
